...
<div class="container">
	...
	<div class="box">
		...
		<div class="col-12 col-sm-6 col-lg-4">
			...
			@if($key<$count)
			@if(isset($friendship_records[$key]->receiver_id) && $friendship_records[$key]->receiver_id == $id )
			<!-- Product Image -->
			...
			<div class="product-description">
				...
				<a href="{{url('add',$row['id'])}}"><button class="btn btn-default">Confirm Friend</button></a>
				<a href="{{url('add',$row['id'])}}"><button class="btn btn-default">Delete Request</button></a>
				@endif
				@endif
			</div>
			<hr />
